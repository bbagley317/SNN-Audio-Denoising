...
for clean_audio_path, combined_audio_path in zip(clean_paths, combined_paths):
    denoised_ss_path = spec_subtraction(combined_audio_path)       # run spec subtraction
    denoised_nsnet2_path = nsnet2(combined_audio_path)             # run nsnet2
    ...
    snr_nsnet2 = calculate_snr(clean_audio, denoised_audio_nsnet2)
