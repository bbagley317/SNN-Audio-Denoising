...
class Model(BaseModel):
    ...
    def forward(self, noisy_mag):
        ...
        fb_output_unfolded = self.freq_unfold(
            fb_output, num_neighbors=self.fb_num_neighbors
        )
        ...
        noisy_mag_unfolded = self.freq_unfold(
            noisy_mag, num_neighbors=self.sb_num_neighbors
        )
