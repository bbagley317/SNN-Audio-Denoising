...
class DNSAudio(Dataset):
    def __init__(self, root="./", limit=None, offset=0, sublen=6, train=True) -> None:
        ...
        self.noisy_files = glob.glob(root + "/**.wav")
...
if __name__ == "__main__":
    print(os.getcwd())
    train_set = DNSAudio(root=os.path.join(os.getcwd(),"noisy_audio\\noisy_audio"))
    validation_set = DNSAudio(root=os.path.join(os.getcwd(),"clean_audio\\clean_audio"))
